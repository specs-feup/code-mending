...
PATH_TO_CMENDER_JAR = "/Users/<substitute>/Desktop/tese/code-mending/cmender/build/libs/cmender.jar"
PATH_TO_DIAG_EXPORTER = "/Users/<substitute>/Desktop/tese/code-mending/diag-exporter/cmake-build-debug/diag-exporter"
...
class Evaluation:    
    def run_cmender_on_files(self, files, output_dirpath):
        ...
        command = f"java {VM_OPTIONS} -jar {PATH_TO_CMENDER_JAR} -dex {PATH_TO_DIAG_EXPORTER} -mendfile-cpi -diags-cpi -od {all_file_paths} -o {output_dirpath} -t 12 -rps"
    ...
    def get_aggr_source_results(self, source_results_df, project_name):
        ...
        return (
                project_name, success_count, unsuccessful_count, fatal_exception_count,
...
if __name__ == '__main__':
    ...
    eval.evaluate(cmender_output_dir="../results/cmender_outputs", eval_output_dir="./results/eval_outputs", 
