...
// TODO instantiate this per file
public class MendingTypeNameGenerator {
    ...
    private static final String CMENDER_ENUM_CONSTANT_NAME_PREFIX = "cmender_enum_constant_type_";

    private static int typedefAliasNameCounter = 0;

    private static int tagTypeNameCounter = 0;

    private static int enumConstantNameCounter = 0;
    ...
    public static String newEnumConstantName() {
        return CMENDER_ENUM_CONSTANT_NAME_PREFIX + enumConstantNameCounter++;
    }
